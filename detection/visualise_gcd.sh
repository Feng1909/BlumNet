...
backbone="swin_small"  # "swin_small"  "vgg16"
visual_type="lines"  # "lines"       "lines&pts"
...
python detection/gcd/test.py --aux_loss --gid --visual_type ${visual_type} --out_pts ${out_pts} \
 --resume ${work_dir}/checkpoint0225.pth  --num_feature_levels 3 --backbone ${backbone} --dataset_file ${data_name}