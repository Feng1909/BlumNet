...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='/home/feng1909/BlumNet/exps/demo/checkpoint.pth', help='resume from checkpoint')
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N', help='start epoch')
    parser.add_argument('--eval', action='store_true')
    parser.add_argument('--eval_score', default=0.85, type=float, help='threshold of prediction')
